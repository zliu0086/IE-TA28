							...
							<div class="sui-notice sui-notice-purple">
								<p>
									...
									printf(
										...
										esc_html__( 'WPMU DEV Hosting offers 3 free websites with features such as dedicated resources, object & page caching, and blazing fast CDN. %1$sTry it out today with a free WMPU DEV membership!%2$s', 'wphb' ),
								...
								<div class="sui-notice-buttons">
									<a href="<?php echo esc_html( Utils::get_link( 'hosting', 'hummingbird_test_response_time_hosting_upsell_learnmore_button' ) ); ?>" target="_blank" class="sui-button sui-button-purple">
			...
			<li>
				...
				<?php if ( ! apply_filters( 'wpmudev_branding_hide_branding', false ) ) : ?>
					<div class="wphb-upsell-performance-row">
						...
						<div class="sui-notice sui-notice-purple">
							<p>
								<?php esc_html_e( 'Check out our Silver, Gold and Platinium plans with more SSD Storage space and up to 16 GB RAM. For even more power you can check out our enterprise WordPress Multisite hosting.', 'wphb' ); ?>
							</p>

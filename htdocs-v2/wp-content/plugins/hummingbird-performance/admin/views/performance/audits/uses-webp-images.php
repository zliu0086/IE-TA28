		...
		<div class="wphb-upsell-performance-row wphb-negative-margin">
			...
			<div class="sui-notice sui-notice-purple">
				...
				<div class="sui-notice-buttons">
					<a href="<?php echo esc_html( \Hummingbird\Core\Utils::get_link( 'smush-plugin', 'hummingbird_report_smush_upsell_link' ) ); ?>" target="_blank" class="sui-button sui-button-purple">

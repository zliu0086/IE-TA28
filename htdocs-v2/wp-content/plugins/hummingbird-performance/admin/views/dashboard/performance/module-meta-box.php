...
<?php if ( $widgets['show_metrics'] ) : ?>
	<div class="sui-box-body wphb-metrics-widget">
		...
		<table class="sui-table">
			<?php $perf_link = \Hummingbird\Core\Utils::get_admin_menu_url( 'performance' ) . '&view=metrics&type=' . $type; ?>
...
<?php if ( $widgets['show_audits'] ) : ?>
	<div class="sui-box-body wphb-audits-widget">
		...
		<ul class="sui-list">
			<?php $perf_link = \Hummingbird\Core\Utils::get_admin_menu_url( 'performance' ) . '&view=audits&type=' . $type; ?>

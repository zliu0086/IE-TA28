                ...
                $quizes_array = array(
                    array(
                        ...
                        'options' => json_encode(array(
                            ...
                            'hide_score' => 'off',
                            'rate_form_title' => 'Did you like this quiz',
                            'enable_box_shadow' => 'on',
                            'box_shadow_color' => '#444',
                            'quiz_border_radius' => '2',
                            'quiz_bg_image' => '',
                            'enable_border' => 'off',
                            'quiz_border_width' => '1',
                            'quiz_border_style' => 'solid',
                            'quiz_border_color' => '#000',
                            'quiz_timer_in_title' => 'on',
                            ...
                            'form_title' => 'Please fill in empty fields',
                            'enable_bg_music' => 'off',
                            'quiz_bg_music' => '',
                            'answers_font_size' => '14',
                            'show_create_date' => 'on',
                            'show_author' => 'off',
                            'enable_early_finish' => 'off',
                            'enable_live_progress_bar' => 'on',
                            'enable_percent_view' => 'on',
                            'enable_average_statistical' => 'on',
                            'enable_next_button' => 'on',
                            'enable_previous_button' => 'on',
                            'enable_arrows' => 'on',
                            'timer_text' => 'You have %%time%% to pass to the quiz.',
                            'quiz_theme' => 'elegant_dark',

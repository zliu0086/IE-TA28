=== DearFlip - WordPress 3D Flipbook, PDF Flipbook ===
Plugin Name: DearFlip - WordPress 3D Flipbook, PDF Flipbook & Viewer
Version: 1.7.3.8
Author: dearhive
...
Realistic 3D Flipbook for WordPress. Create 3D flipbook using PDFs or Images and engage your readers. Just add the link and flipbook is ready to flip.

== Description ==
>Important Notice: DearFlip ( also know as dFlip) is now sold on [dearflip.com](https://dearflip.com/go/wp-lite-full-version) instead of CodeCanyon.net
...
**DearFlip is a stunning 3D flipbook alternative for your flat lifeless PDFs**
DearFlip's easy post structure makes it easy to create flipbook inside WordPress. Create 3D flipbook, make your PDFs interactive and generate more customer attention.
...
### Just 5 Steps! ###
WordPress is famous for it’s easy to learn and use structure. DearFlip follows WordPress post structure for creating and managing 3D flipbook. It’s easy and simple just like creating a post.
...
### Features ###
 ...
 - Supports any number of pages, more than 1000 pages and 500MB. Visit Trom site for their amazing flipbook.
...
>Its amazing - I have tried the others, this for me is the best
 Simple to setup, add books and use
...
= How to install DearFlip flipbook Wordpress plugin? =
...
> Note: When upgrading to PRO version of DearFlip 3D flipbook WordPress plugin, make sure you deactivate the lite version. Your flipbook created with lite version will stay in the database and work seamlessly. If you are using cache plugin, we recommend clearing cache if any issues arises.
...
DearFlip 3D Flipbook uses PDF.js to render the PDF pages. At any given time it requires only 6 pages of data at max. So the amount of pages in a PDF file doesn't really affect the 3D Flipbook. Also, it only load 6 Pages of data to start the flipbook and this makes it resource friendly and traffic friendly 3D flipbook. Other 3D flipbook might crash with huge files, DearFlip will last longer.
...
1. PDF links are premium feature in DearFlip, and won't be displayed in lite version of DearFlip 3D Flipbook WordPress Plugin. You can test your PDF links to check how they work in our online [PDF Flipbook Viewer](https://dearflip.com/go/wp-lite-pdf-viewer).
2. Also pay attention that some desktop readers auto convert URL text to links and give an assumption that those are links. Such links won't work in every reader and devices. One of the popular case is Adobe PDF Reader: it auto-converts the text URLs to links in desktop but doesn't in mobile app. So we suggest to define links explicitly and not rely on PDF reader's auto conversion capability.
...
4. 2D Flipbook as fallback; when the browser doesnt support 3D WebGL. As of 2020, 97% of the browsers support WebGL

...
class CRPDashboardListTable extends WP_List_Table {
    ...
    function fetchData(){
        ...
        for($i=0; $i<count($results); $i++){
            ...
            //Build row actions
            $actions = array(
                'options'   => sprintf('<a href="?page=%s&action=%s&id=%s" class="crp-settings-btn" style="float: left; margin-right: 7px;"><i class="fa fa-cog fa-fw" style="font-size: 14px; padding: 5px 0 0 3px;"></i></a>', filter_var($_REQUEST['page'], FILTER_SANITIZE_STRING),'options',$pid),
                'edit'      => sprintf('<a href="?page=%s&action=%s&id=%s&type=%s" class="crp-edit-btn" style="float: left; margin-right: 7px;"><i class="fa fa-pencil" style="font-size: 14px; padding: 5px 0 0 6px;"></i></a>', filter_var($_REQUEST['page'], FILTER_SANITIZE_STRING),'edit',$pid, $type),
                'delete'    => sprintf('<a href="?page=%s&action=%s&id=%s" class="crp-delete-btn" onclick="if(!confirm(\'Are you sure you want to delete the portfolio?\')) return false;" style="float: left; margin-right: 7px; margin-top: 0px;"><i class="fa fa-minus" style="font-size: 14px;padding: 6px 0 0 6px"></i></a>', filter_var($_REQUEST['page'], FILTER_SANITIZE_STRING),'delete',$pid),

...
<div class="crp-portfolio-header">
    ...
    <div class="crp-three-parts crp-fl crp-title-part"><input id="crp-portfolio-title" class="crp-portfolio-title" name="portfolio-title" maxlength="250" placeholder="Enter team name" type="text"></div>
...
<div class="crp-gallery-wrapper crp-team-wrapper">
    <div class="crp-add-item-boxes">
        <div class="crp-add-item-box"><a id="crp-add-picture-button" class='button-secondary crp-add-project-button crp-glazzed-btn crp-glazzed-btn-green' href='#' title='Add new member'>+ Add member</a></div>
    </div>
...
//        handle: 'span'
    ...
    function crp_addProjectItem(crp_project )
    {
        ...
        html +=
            ...
            '<div class="crp-content-box"><input type="text" placeholder="Enter full name" name="project.title" value=""></div>' +
            '<div class="crp-content-box"><textarea rows=3 placeholder="Enter info" name="project.description"></textarea></div>' +
            '<div class="crp-content-box"><input type="text" disabled="disabled" placeholder="Enter facebook link (PRO)" name="project.fb_link" value=""></div>' +
            '<div class="crp-content-box"><input type="text" disabled="disabled" placeholder="Enter linkedin link (PRO)" name="project.ln_link" value=""></div>' +
            '<div class="crp-content-box"><input type="text" placeholder="Enter custom link (http://example.com)" name="project.url" value=""></div>' +
            '</td>' +
    ...
    function crp_updateModel(){
        ...
        crp_portfolio.extoptions = {
            all_cats: {},
            type: '<?php echo CRPGridType::TEAM; ?>'
        };
    ...
    function onPortfolioOptions() {
        if (crp_portfolio.isDraft) {
            ...
            var href = "?page=" + crp_adminPage + "&action=options&id=" + crp_portfolio.id+'&type=<?php echo CRPGridType::TEAM; ?>';
            crp_loadHref(href);
        }
    }
</script>

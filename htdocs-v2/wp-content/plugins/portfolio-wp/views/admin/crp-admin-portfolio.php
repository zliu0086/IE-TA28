...
<div class="crp-portfolio-header">
    ...
    <div class="crp-three-parts crp-fl crp-title-part"><input id="crp-portfolio-title" class="crp-portfolio-title" name="portfolio-title" maxlength="250" placeholder="Enter portfolio title" type="text"></div>
...
<div class="crp-project-wrapper">
    <aside class="crp-project-sidebar">
        <div>
            <a id="crp-add-project-button" class='button-secondary crp-add-project-button crp-glazzed-btn crp-glazzed-btn-green' href='#' title='Add new'>+ Add project</a>
        </div>
...
function crp_updateModel(){
  //To make sure it's valid JS object
    ...
    crp_portfolio.extoptions = {
        all_cats: {},
        type: '<?php echo CRPGridType::PORTFOLIO; ?>'
    };

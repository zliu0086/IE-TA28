...
<div id="anatomy-admin">
  <div id="anatomy-header">
    <p class="anatomy-shortcode">Insert this shortcode <input type="text" value="[anatomy]" readonly> into any page or post to display the interactive drawing. &nbsp; | &nbsp; <span class="submit"><input type="submit" name="submit" id="submit" class="button button-primary" value="Save Changes"></span></p>
  </div>
  <div id="anatomy-page">
    <div class="anatomy-col-lt">
      ...
      <div class="anatomy-settings">
        ...
        <div class="box-body">
              ...
              <div class="area-url">
                ...
                <p><label>Target</label>
                  <select name="turl_1">
                    ...
                    <option value="none" <?php if($anatomy['turl_1'] == 'none'){echo "selected";} ?>>None / Modal</option>
                  </select>
                </p>
              </div>
              ...
              <div class="area-url">
                ...
                <p><label>Target</label>
                  <select name="turl_2">
                    ...
                    <option value="none" <?php if($anatomy['turl_2'] == 'none'){echo "selected";} ?>>None / Modal</option>
                  </select>
                </p>
              </div>
              ...
              <div class="area-url">
                ...
                <p><label>Target</label>
                  <select name="turl_3">
                    ...
                    <option value="none" <?php if($anatomy['turl_3'] == 'none'){echo "selected";} ?>>None / Modal</option>
                  </select>
                </p>
              </div>
              ...
              <div class="area-url">
                ...
                <p><label>Target</label>
                  <select name="turl_4">
                    ...
                    <option value="none" <?php if($anatomy['turl_4'] == 'none'){echo "selected";} ?>>None / Modal</option>
                  </select>
                </p>
              </div>
              ...
              <div class="area-url">
                ...
                <p><label>Target</label>
                  <select name="turl_5">
                    ...
                    <option value="none" <?php if($anatomy['turl_5'] == 'none'){echo "selected";} ?>>None / Modal</option>
                  </select>
                </p>
              </div>
              ...
              <div class="area-url">
                ...
                <p><label>Target</label>
                  <select name="turl_6">
                    ...
                    <option value="none" <?php if($anatomy['turl_6'] == 'none'){echo "selected";} ?>>None / Modal</option>
                  </select>
                </p>
              </div>
          ...
          <div class="org-area"><p class="area-name">SHOULDER [Right]</p>
              ...
              <div class="area-url">
                ...
                <p><label>Target</label>
                  <select name="turl_7">
                    ...
                    <option value="none" <?php if($anatomy['turl_7'] == 'none'){echo "selected";} ?>>None / Modal</option>
                  </select>
                </p>
              </div>
          ...
          <div class="org-area"><p class="area-name">SHOULDER [Left]</p>
              ...
              <div class="area-url">
                ...
                <p><label>Target</label>
                  <select name="turl_8">
                    ...
                    <option value="none" <?php if($anatomy['turl_8'] == 'none'){echo "selected";} ?>>None / Modal</option>
                  </select>
                </p>
              </div>
          ...
          <div class="org-area"><p class="area-name">ARM [Right]</p>
              ...
              <div class="area-url">
                ...
                <p><label>Target</label>
                  <select name="turl_9">
                    ...
                    <option value="none" <?php if($anatomy['turl_9'] == 'none'){echo "selected";} ?>>None / Modal</option>
                  </select>
                </p>
              </div>
          ...
          <div class="org-area"><p class="area-name">ARM [Left]</p>
              ...
              <div class="area-url">
                ...
                <p><label>Target</label>
                  <select name="turl_10">
                    ...
                    <option value="none" <?php if($anatomy['turl_10'] == 'none'){echo "selected";} ?>>None / Modal</option>
                  </select>
                </p>
              </div>
          ...
          <div class="org-area"><p class="area-name">ELBOW [Right]</p>
              ...
              <div class="area-url">
                ...
                <p><label>Target</label>
                  <select name="turl_11">
                    ...
                    <option value="none" <?php if($anatomy['turl_11'] == 'none'){echo "selected";} ?>>None / Modal</option>
                  </select>
                </p>
              </div>
          ...
          <div class="org-area"><p class="area-name">ELBOW [Left]</p>
              ...
              <div class="area-url">
                ...
                <p><label>Target</label>
                  <select name="turl_12">
                    ...
                    <option value="none" <?php if($anatomy['turl_12'] == 'none'){echo "selected";} ?>>None / Modal</option>
                  </select>
                </p>
              </div>
          ...
          <div class="org-area"><p class="area-name">FOREARM [Right]</p>
              ...
              <div class="area-url">
                ...
                <p><label>Target</label>
                  <select name="turl_13">
                    ...
                    <option value="none" <?php if($anatomy['turl_13'] == 'none'){echo "selected";} ?>>None / Modal</option>
                  </select>
                </p>
              </div>
          ...
          <div class="org-area"><p class="area-name">FOREARM [Left]</p>
              ...
              <div class="area-url">
                ...
                <p><label>Target</label>
                  <select name="turl_14">
                    ...
                    <option value="none" <?php if($anatomy['turl_14'] == 'none'){echo "selected";} ?>>None / Modal</option>
                  </select>
                </p>
              </div>
          ...
          <div class="org-area"><p class="area-name">WRIST [Right]</p>
              ...
              <div class="area-url">
                ...
                <p><label>Target</label>
                  <select name="turl_15">
                    ...
                    <option value="none" <?php if($anatomy['turl_15'] == 'none'){echo "selected";} ?>>None / Modal</option>
                  </select>
                </p>
              </div>
          ...
          <div class="org-area"><p class="area-name">WRIST [Left]</p>
              ...
              <div class="area-url">
                ...
                <p><label>Target</label>
                  <select name="turl_16">
                    ...
                    <option value="none" <?php if($anatomy['turl_16'] == 'none'){echo "selected";} ?>>None / Modal</option>
                  </select>
                </p>
              </div>
          ...
          <div class="org-area"><p class="area-name">HAND [Right]</p>
              ...
              <div class="area-url">
                ...
                <p><label>Target</label>
                  <select name="turl_17">
                    ...
                    <option value="none" <?php if($anatomy['turl_17'] == 'none'){echo "selected";} ?>>None / Modal</option>
                  </select>
                </p>
              </div>
          ...
          <div class="org-area"><p class="area-name">HAND [Left]</p>
              ...
              <div class="area-url">
                ...
                <p><label>Target</label>
                  <select name="turl_18">
                    ...
                    <option value="none" <?php if($anatomy['turl_18'] == 'none'){echo "selected";} ?>>None / Modal</option>
                  </select>
                </p>
              </div>
          ...
          <div class="org-area"><p class="area-name">THIGH [Right]</p>
              ...
              <div class="area-url">
                ...
                <p><label>Target</label>
                  <select name="turl_19">
                    ...
                    <option value="none" <?php if($anatomy['turl_19'] == 'none'){echo "selected";} ?>>None / Modal</option>
                  </select>
                </p>
              </div>
          ...
          <div class="org-area"><p class="area-name">THIGH [Left]</p>
              ...
              <div class="area-url">
                ...
                <p><label>Target</label>
                  <select name="turl_20">
                    ...
                    <option value="none" <?php if($anatomy['turl_20'] == 'none'){echo "selected";} ?>>None / Modal</option>
                  </select>
                </p>
              </div>
          ...
          <div class="org-area"><p class="area-name">KNEE [Right]</p>
              ...
              <div class="area-url">
                ...
                <p><label>Target</label>
                  <select name="turl_21">
                    ...
                    <option value="none" <?php if($anatomy['turl_21'] == 'none'){echo "selected";} ?>>None / Modal</option>
                  </select>
                </p>
              </div>
          ...
          <div class="org-area"><p class="area-name">KNEE [Left]</p>
              ...
              <div class="area-url">
                ...
                <p><label>Target</label>
                  <select name="turl_22">
                    ...
                    <option value="none" <?php if($anatomy['turl_22'] == 'none'){echo "selected";} ?>>None / Modal</option>
                  </select>
                </p>
              </div>
          ...
          <div class="org-area"><p class="area-name">LEG [Right]</p>
              ...
              <div class="area-url">
                ...
                <p><label>Target</label>
                  <select name="turl_23">
                    ...
                    <option value="none" <?php if($anatomy['turl_23'] == 'none'){echo "selected";} ?>>None / Modal</option>
                  </select>
                </p>
              </div>
          ...
          <div class="org-area"><p class="area-name">LEG [Left]</p>
              ...
              <div class="area-url">
                ...
                <p><label>Target</label>
                  <select name="turl_24">
                    ...
                    <option value="none" <?php if($anatomy['turl_24'] == 'none'){echo "selected";} ?>>None / Modal</option>
                  </select>
                </p>
              </div>
          ...
          <div class="org-area"><p class="area-name">ANKLE [Right]</p>
              ...
              <div class="area-url">
                ...
                <p><label>Target</label>
                  <select name="turl_25">
                    ...
                    <option value="none" <?php if($anatomy['turl_25'] == 'none'){echo "selected";} ?>>None / Modal</option>
                  </select>
                </p>
              </div>
          ...
          <div class="org-area"><p class="area-name">ANKLE [Left]</p>
              ...
              <div class="area-url">
                ...
                <p><label>Target</label>
                  <select name="turl_26">
                    ...
                    <option value="none" <?php if($anatomy['turl_26'] == 'none'){echo "selected";} ?>>None / Modal</option>
                  </select>
                </p>
              </div>
          ...
          <div class="org-area"><p class="area-name">FOOT [Right]</p>
              ...
              <div class="area-url">
                ...
                <p><label>Target</label>
                  <select name="turl_27">
                    ...
                    <option value="none" <?php if($anatomy['turl_27'] == 'none'){echo "selected";} ?>>None / Modal</option>
                  </select>
                </p>
              </div>
          ...
          <div class="org-area"><p class="area-name">FOOT [Left]</p>
              ...
              <div class="area-url">
                ...
                <p><label>Target</label>
                  <select name="turl_28">
                    ...
                    <option value="none" <?php if($anatomy['turl_28'] == 'none'){echo "selected";} ?>>None / Modal</option>
                  </select>
                </p>
              </div>

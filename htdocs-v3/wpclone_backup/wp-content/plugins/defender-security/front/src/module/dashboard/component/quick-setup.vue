                ...
                <div class="sui-box-header">
                    ...
                    <div class="sui-actions-right">
                        <form method="post" @submit.prevent="skip">
                            <submit-button type="submit" css-class="sui-button-ghost quicksetup-skip" :state="state">
                                {{__("Skip")}}
                            </submit-button>
                        </form>
                    </div>
                            ...
                            <div class="sui-col-md-2">
                                <div class="sui-form-field tr">
                                    <label class="sui-toggle">
                                        <input type="checkbox"
                                               name="activator[]" checked
                                               class="toggle-checkbox" v-model="model.activate_audit" id="active_audit"
                                               value="activate_audit"/>
                                        <span class="sui-toggle-slider"></span>
                                    </label>
                                </div>
                            </div>
                        ...
                        <div class="sui-row">
                            ...
                            <div class="sui-col-md-2">
                                <div class="sui-form-field tr">
                                    <label class="sui-toggle">
                                        <input type="checkbox" checked
                                               name="activator[]" v-model="model.activate_blacklist"
                                               class="toggle-checkbox" id="activate_blacklist"

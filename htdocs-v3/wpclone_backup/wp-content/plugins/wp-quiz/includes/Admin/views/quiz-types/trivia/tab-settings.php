...
$cmb->add_field(
	array(
		...
		'desc'       => __( '(applies to multiple page layout from the styling tab)', 'wp-quiz' ),
		'attributes' => array(
			'type' => 'number',
			'min'  => 0,
			'step' => 1,
...
$cmb->add_field(
	array(
		'type'       => 'text_small',
		'name'       => __( 'Overall time in seconds', 'wp-quiz' ),
		'id'         => 'wp_quiz_overall_time',
		'desc'       => __( 'Set overall time to complete the quiz.', 'wp-quiz' ),
		'attributes' => array(
			'type' => 'number',
			'min'  => 0,
			'step' => 1,
...
$cmb->add_field(
	array(
		'type'    => 'switch',
		'name'    => __( 'Show right/wrong answers at the end of the quiz.', 'wp-quiz' ),

...
function cursor_custom_add_script_and_style() {
    ...
    $url_on_link = ( isset( $options['onlink'] ) && $options['onlink'] == 'on' ) ? $options['cursor_file1']['url_new'] : $options['cursor_file2']['url_new'];
    ...
    body span, 
    body div {
        cursor: url({$options['cursor_file1']['url_new']}), auto!important;
    }
    ...
    ?>
        <div style="max-width:200px;">
            ...
            <?php if ( isset( $options['cursor_file1']['url_new'] ) ) { ?>
                ...
                <div style="margin:20px 0px; max-width:200px; text-align:center;">
...
function cursor_custom_cursor_image_cb2() {
    ...
    ?>
        <div>
            ...
            <div class="subinput" style="margin:20px 0px; max-width:200px; text-align:center;">

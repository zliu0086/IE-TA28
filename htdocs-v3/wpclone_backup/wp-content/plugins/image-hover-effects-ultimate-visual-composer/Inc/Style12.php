        ...
        <div class="oxi-addons-tabs-content-tabs" id="oxilab-tabs-id-4">
            <div class="oxi-addons-col-6">
                ...
                <div class="oxi-addons-content-div">
                    ...
                    echo $this->oxilab_flip_box_admin_color('front-icon-color', $this->style[9], '', 'Icon Color', 'Set your Icon Color', 'color', '.oxilab-flip-box-' . $this->oxiid . '-data2 .oxilab-icon-data [class^=\'fa\']');
                    ...
                    echo $this->oxilab_flip_box_admin_number('front-icon-height', $this->style[75], '1', 'Icon Box Hight', 'Set your Icon Box height, start with the top.');
        ...
        <div class="oxi-addons-tabs-content-tabs" id="oxilab-tabs-id-3">
            <div class="oxi-addons-col-6">
                <div class="oxi-addons-content-div">
                    ...
                    <?php
                    echo $this->oxilab_flip_box_admin_color('backend-background-color', $this->style[17], 'rgba', 'Background Color', 'Set your Backend Background Color', 'background-color', '.oxilab-flip-box-back-' . $this->oxiid . '');
                    echo $this->oxilab_flip_box_admin_color('backend-border-color', $this->style[19], '', 'Border Color', 'Set your Border Color', 'border-color', '.oxilab-flip-box-back-' . $this->oxiid . '');
                ...
                <div class="oxi-addons-content-div">
                    ...
                    echo $this->oxilab_flip_box_admin_color('backend-title-color', $this->style[21], '', 'Title Color', 'Set your Backend title Color', 'color', '.oxilab-flip-box-back-' . $this->oxiid . '-data .oxilab-heading');
            ...
            <div class="oxi-addons-col-6">
                <div class="oxi-addons-content-div">
                    ...
                    <?php
                    echo $this->oxilab_flip_box_admin_number('backend-title-border-width', $this->style[175], '1', 'Border Width', 'Set your Backend Title Bottom Border Width');
                    echo $this->oxilab_flip_box_admin_number('backend-title-border-height', $this->style[177], '1', 'Border Height', 'Set your Backend Title Bottom Border Height');
                    echo $this->oxilab_flip_box_admin_color('backend-title-bottom-border-color', $this->style[23], '', 'Title Bottom Color', 'Set your Backend Title Bottom Border Color', 'background-color', '.oxilab-flip-box-back-' . $this->oxiid . '-data .oxilab-heading .oxilab-span');
                    ?>    
                </div> 
                <div class="oxi-addons-content-div">
                    <div class="oxi-head">

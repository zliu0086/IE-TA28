...
class Style10 extends Admin_Render {
        ...
        <div class="oxi-addons-tabs-content-tabs" id="oxilab-tabs-id-5">
            <div class="oxi-addons-col-6">
                <div class="oxi-addons-content-div">
                    ...
                    echo $this->oxilab_flip_box_admin_number('flip-border-radius', $this->style[69], '1', 'Border Radius', 'Set your flip Border Radius');
                    ?>    
                </div> 
                <div class="oxi-addons-content-div">
                    <div class="oxi-head">
        ...
        <div class="oxi-addons-tabs-content-tabs" id="oxilab-tabs-id-4">
            <div class="oxi-addons-col-6">
                ...
                <div class="oxi-addons-content-div">
                    ...
                    echo $this->oxilab_flip_box_admin_color('front-icon-background-color', $this->style[9], '', 'Icon Background Color', 'Set your Icon Background Color', 'background-color', '.oxilab-flip-box-' . $this->oxiid . '-data .oxilab-icon-data');
        ...
        <div class="oxi-addons-tabs-content-tabs" id="oxilab-tabs-id-3">
            <div class="oxi-addons-col-6">
                ...
                <div class="oxi-addons-content-div">
                    ...
                    echo $this->oxilab_flip_box_admin_color('backend-icon-color', $this->style[15], '', 'Icon Color', 'Set your Icon Color', 'color', '.oxilab-flip-box-back-' . $this->oxiid . '-data .oxilab-icon-data [class^=\'fa\']');
        ...
        <div class="oxi-addons-tabs-content-tabs" id="oxilab-tabs-id-2">
            <div class="col-xs-12 p-2">
                <div class="form-group">
                    ...
                    <textarea class="form-control" rows="4" id="custom-css" name="custom-css"><?php echo $this->style[137]; ?></textarea>
    ...
    public function modal_form_data() {
        ...
        <div class="modal-body row">
            <?Php
            echo $this->oxilab_flip_box_admin_input_icon('flip-box-backend-icons', $this->child_editable[9], 'Backend Icon', 'Add your Backend icon, Use Font-Awesome class name. As example fab fa-facebook-f');

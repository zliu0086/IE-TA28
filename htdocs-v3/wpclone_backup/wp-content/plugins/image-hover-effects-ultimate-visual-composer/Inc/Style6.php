        ...
        <div class="oxi-addons-tabs-content-tabs" id="oxilab-tabs-id-3">
            <div class="oxi-addons-col-6">
                <div class="oxi-addons-content-div">
                    ...
                    echo $this->oxilab_flip_box_admin_border('flip-backend-border-size', $this->style[97], 'flip-backend-border-style', $this->style[99], 'Border Size', 'Set your front border size with different style');

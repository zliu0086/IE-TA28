...
class Style13 extends Admin_Render {
    ...
    public function register_style() {
        $data = 'oxilab-flip-type |' . sanitize_text_field($_POST['oxilab-flip-type']) . '|'
                ...
                . ' front-icon-border-color|' . sanitize_hex_color($_POST['front-icon-border-color']) . '| '
        ...
        <div class="oxi-addons-tabs-content-tabs" id="oxilab-tabs-id-4">
            <div class="oxi-addons-col-6">
                ...
                <div class="oxi-addons-content-div">
                    ...
                    echo $this->oxilab_flip_box_admin_color('front-icon-background-color', $this->style[11], '', 'Icon Background Color', 'Set your Icon Background Color', 'background-color', '.oxilab-flip-box-' . $this->oxiid . '-data .oxilab-icon-data [class^=\'fa\']');
                    echo $this->oxilab_flip_box_admin_color('front-icon-border-color', $this->style[7], '', 'Border Color', 'Set your Icon Border Color', 'border-color', '.oxilab-flip-box-' . $this->oxiid . '-data .oxilab-icon-data');
            ...
            <div class="oxi-addons-col-6">
                ...
                <div class="oxi-addons-content-div">
                    ...
                    echo $this->oxilab_flip_box_admin_color('front-info-color', $this->style[29], '', 'Text Color', 'Set your Front Heading Color', 'color', '.oxilab-flip-box-' . $this->oxiid . '-data .oxilab-info');

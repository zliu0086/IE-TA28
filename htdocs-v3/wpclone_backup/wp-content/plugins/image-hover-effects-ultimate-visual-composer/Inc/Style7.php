...
class Style7 extends Admin_Render {
    ...
    public function register_style() {
        $data = 'oxilab-flip-type |' . sanitize_text_field($_POST['oxilab-flip-type']) . '|'
                ...
                . ' || '
                . ' front-icon-color |' . sanitize_text_field($_POST['front-icon-color']) . '|'
                . ' ||'
        ...
        <div class="oxi-addons-tabs-content-tabs" id="oxilab-tabs-id-2">
            <div class="col-xs-12 p-2">
                <div class="form-group">
                    ...
                    <textarea class="form-control" rows="4" id="custom-css" name="custom-css"><?php echo $this->style[181]; ?></textarea>

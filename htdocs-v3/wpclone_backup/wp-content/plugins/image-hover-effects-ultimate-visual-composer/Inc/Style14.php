        ...
        <div class="oxi-addons-tabs-content-tabs" id="oxilab-tabs-id-5">
            <div class="oxi-addons-col-6">
                <div class="oxi-addons-content-div">
                    ...
                    echo $this->oxilab_flip_box_admin_number('flip-border-radius', $this->style[129], '1', 'Border Radius', 'Set your flip Border Radius');
                    ?>    
                </div> 
                <div class="oxi-addons-content-div">
                    <div class="oxi-head">
        ...
        <div class="oxi-addons-tabs-content-tabs" id="oxilab-tabs-id-4">
            <div class="oxi-addons-col-6">
                <div class="oxi-addons-content-div">
                    ...
                    <?php
                    echo $this->oxilab_flip_box_admin_color('front-background-color', $this->style[5], 'rgba', 'Background Color', 'Set your Front Background Color', 'background-color', '.oxilab-flip-box-body-' . $this->oxiid . ' .oxilab-flip-box-front');
                    echo $this->oxilab_flip_box_admin_number_double('front-padding-top', $this->style[71], 'front-padding-left', $this->style[73], 'Padding', 'Set your Front Padding as Top Bottom and Left Right');
                    echo $this->oxilab_flip_box_admin_number_double('front-inner-padding-top', $this->style[185], 'front-inner-padding-left', $this->style[187], 'Inner Padding', 'Set your Front Inner Padding as Top Bottom and Left Right');
                    echo $this->oxilab_flip_box_admin_color('front-border-color', $this->style[7], '', 'Border Color', 'Set your Border Color', 'border-color', '.oxilab-flip-box-body-' . $this->oxiid . ' .oxilab-flip-box-front');
                    echo $this->oxilab_flip_box_admin_border('flip-col-border-size', $this->style[125], 'flip-col-border-style', $this->style[127], 'Border Size', 'Set your front border size with different style');
                    echo $this->oxilab_flip_box_admin_border('flip-col-inner-border-size', $this->style[179], 'flip-col-inner-border-style', $this->style[181], 'Inner Border Size', 'Set your front border size with different style');
                    echo $this->oxilab_flip_box_admin_color('front-inner-border-color', $this->style[27], '', 'Inner Border Color', 'Set your Inner Border Color', 'border-color', '.oxilab-flip-box-' . $this->oxiid . '');
                    echo $this->oxilab_flip_box_admin_number('flip-inner-border-radius', $this->style[183], '1', 'Inner Border Radius', 'Set your flip Inner Border Radius');
                    ?>    
                </div> 
                <div class="oxi-addons-content-div">
                    <div class="oxi-head">
                    ...
                    <?php
                    echo $this->oxilab_flip_box_admin_number('front-icon-size', $this->style[77], '1', 'Number Size', 'Set your Number Font Size');
                    echo $this->oxilab_flip_box_admin_color('front-icon-color', $this->style[9], '', 'Icon Color', 'Set your Icon Color', 'color', '.oxilab-flip-box-' . $this->oxiid . '-data2 .oxilab-icon-data .oxilab-span');
                    echo $this->oxilab_flip_box_admin_color('front-icon-background', $this->style[11], 'rgba', 'Icon Background', 'Set your icon Background Color', 'background-color', '.oxilab-flip-box-' . $this->oxiid . '-data2');
                    echo $this->oxilab_flip_box_admin_number('front-icon-width', $this->style[79], '1', 'Number width', 'Set your Number Width and Height Size.');
                    echo $this->oxilab_flip_box_admin_number('front-icon-height', $this->style[75], '1', 'Number Box Hight', 'Set your Number Box height, start with the top.');
                    echo $this->oxilab_flip_box_admin_number_double('front-icon-padding-top-bottom', $this->style[135], 'front-icon-padding-left-right', $this->style[137], 'Icon Padding', 'Set your Number Padding as Top Bottom and Left Right');
                    echo $this->oxilab_flip_box_admin_number('front-icon-border-radius', $this->style[81], '1', 'Border Radius', 'Set Your Number Border Radius');
                    ?> 
                </div>
            </div>
            <div class="oxi-addons-col-6">
                <div class="oxi-addons-content-div">
                    ...
                    <?php
                    echo $this->oxilab_flip_box_admin_number('front-heading-size', $this->style[83], '1', 'Font Size', 'Set your front Heading Font Size');
                    echo $this->oxilab_flip_box_admin_color('front-heading-color', $this->style[13], '', 'Heading Color', 'Set your Front Heading Color', 'color', '.oxilab-flip-box-' . $this->oxiid . '-data .oxilab-heading');
                    echo $this->oxilab_flip_box_admin_font_family('front-heading-family', $this->style[85], 'Font Family', 'Give your Prepared Font from our Google Font List');
                    echo $this->oxilab_flip_box_admin_font_style('front-heding-style', $this->style[87], 'Font Style', 'Set your Heading Font Style');
                    echo $this->oxilab_flip_box_admin_font_weight('front-heding-weight', $this->style[89], 'Font Weight', 'Give your Front Heading Font Weight');
                    echo $this->oxilab_flip_box_admin_text_align('front-heding-text-align', $this->style[91], 'Text Align', 'Give your Heading Text Align');
                    echo $this->oxilab_flip_box_admin_number_double('front-heding-padding-top', $this->style[93], 'front-heding-padding-bottom', $this->style[95], 'Padding Top Bottom', 'Set Your Heading  Padding Top and Bottom');
                    echo $this->oxilab_flip_box_admin_number_double('front-heding-padding-left', $this->style[97], 'front-heding-padding-right', $this->style[99], 'Padding Left Right', 'Set Your Heading  Padding Left and Right');
                    ?> 
                </div> 
                <div class="oxi-addons-content-div">
                    <div class="oxi-head">
                    ...
                    <?php
                    echo $this->oxilab_flip_box_admin_number('front-info-size', $this->style[139], '1', 'Font Size', 'Set your front Info Font Size');
                    echo $this->oxilab_flip_box_admin_color('front-info-color', $this->style[15], '', 'Text Color', 'Set your Front Heading Color', 'color', '.oxilab-flip-box-' . $this->oxiid . '-data .oxilab-info');
                    echo $this->oxilab_flip_box_admin_font_family('front-info-family', $this->style[141], 'Font Family', 'Give your Prepared Font from our Google Font List');
                    echo $this->oxilab_flip_box_admin_font_style('front-info-style', $this->style[143], 'Font Style', 'Set your Info Font Style');
                    echo $this->oxilab_flip_box_admin_font_weight('front-info-weight', $this->style[145], 'Font Weight', 'Give your Front Info Font Weight');
                    echo $this->oxilab_flip_box_admin_text_align('front-info-text-align', $this->style[147], 'Text Align', 'Give your Info Text Align');
                    echo $this->oxilab_flip_box_admin_number_double('front-info-padding-top', $this->style[149], 'front-info-padding-bottom', $this->style[151], 'Padding Top Bottom', 'Set Your Info  Padding Top and Bottom');
                    echo $this->oxilab_flip_box_admin_number_double('front-info-padding-left', $this->style[153], 'front-info-padding-right', $this->style[155], 'Padding Left Right', 'Set Your Info  Padding Left and Right');
                    ?> 
                </div> 
            </div>
        </div>
        <div class="oxi-addons-tabs-content-tabs" id="oxilab-tabs-id-3">
            <div class="oxi-addons-col-6">
                <div class="oxi-addons-content-div">
                    ...
                    <?php
                    echo $this->oxilab_flip_box_admin_color('backend-background-color', $this->style[17], 'rgba', 'Background Color', 'Set your Backend Background Color', 'background-color', '.oxilab-flip-box-body-' . $this->oxiid . ' .oxilab-flip-box-back');
                    ...
                    echo $this->oxilab_flip_box_admin_number_double('front-backend-inner-padding-top', $this->style[195], 'front-backend-inner-padding-left', $this->style[197], 'Inner Padding', 'Set your backend Inner Padding as Top Bottom and Left Right');
                    echo $this->oxilab_flip_box_admin_border('flip-backend-border-size', $this->style[131], 'flip-backend-border-style', $this->style[133], 'Border Size', 'Set your backend border size with different style');
                    echo $this->oxilab_flip_box_admin_color('backend-border-color', $this->style[19], '', 'Border Color', 'Set your Border Color', 'border-color', '.oxilab-flip-box-body-' . $this->oxiid . ' .oxilab-flip-box-back');
                    echo $this->oxilab_flip_box_admin_border('flip-backend-inner-border-size', $this->style[189], 'flip-backend-inner-border-style', $this->style[191], 'Inner Border Size', 'Set your Backend border size with different style');
                    echo $this->oxilab_flip_box_admin_color('backend-inner-border-color', $this->style[29], '', 'Inner Border Color', 'Set your Inner Border Color', 'border-color', '.oxilab-flip-box-back-' . $this->oxiid . '');
                    echo $this->oxilab_flip_box_admin_number('flip-backend-inner-border-radius', $this->style[193], '1', 'Inner Border Radius', 'Set your Backend flip Inner Border Radius');
                    ?>    
                </div> 
                <div class="oxi-addons-content-div">
                    <div class="oxi-head">
                    ...
                    <?php
                    echo $this->oxilab_flip_box_admin_number('backend-icon-size', $this->style[199], '1', 'Icon Size', 'Set your Icon Font Size');
                    echo $this->oxilab_flip_box_admin_color('backend-icon-color', $this->style[39], '', 'Icon Color', 'Set your Icon Color', 'color', '.oxilab-flip-box-back-' . $this->oxiid . '-data2 .oxilab-icon-data [class^=\'fa\']');
                    echo $this->oxilab_flip_box_admin_color('backend-icon-background', $this->style[41], 'rgba', 'Icon Background', 'Set your icon Background Color', 'background-color', '.oxilab-flip-box-back-' . $this->oxiid . '-data2');
                    echo $this->oxilab_flip_box_admin_number('backend-icon-width', $this->style[201], '1', 'Icon width', 'Set your Icon Width and Height Size.');
                    echo $this->oxilab_flip_box_admin_number('backend-icon-height', $this->style[203], '1', 'Icon Box Hight', 'Set your Icon Box height, start with the top.');
                    echo $this->oxilab_flip_box_admin_number_double('backend-icon-padding-top-bottom', $this->style[205], 'backend-icon-padding-left-right', $this->style[207], 'Icon Padding', 'Set your Icon Padding as Top Bottom and Left Right');
                    echo $this->oxilab_flip_box_admin_number('backend-icon-border-radius', $this->style[209], '1', 'Border Radius', 'Set Your Icon Border Radius');
                    ?> 
                </div>
                <div class="oxi-addons-content-div">
                    <div class="oxi-head">
                    ...
                    <?php
                    echo $this->oxilab_flip_box_admin_number('backend-heading-size', $this->style[157], '1', 'Font Size', 'Set your backend Heading Font Size');
                    echo $this->oxilab_flip_box_admin_color('backend-title-color', $this->style[21], '', 'Heading Color', 'Set your Backend title Color', 'color', '.oxilab-flip-box-back-' . $this->oxiid . '-data .oxilab-heading');
                    echo $this->oxilab_flip_box_admin_font_family('backend-heading-family', $this->style[159], 'Font Family', 'Give your Prepared Font from our Google Font List');
                    echo $this->oxilab_flip_box_admin_font_style('backend-heading-style', $this->style[161], 'Font Style', 'Set your Heading Font Style');
                    echo $this->oxilab_flip_box_admin_font_weight('backend-heading-weight', $this->style[163], 'Font Weight', 'Give your backend Heading Font Weight');
                    echo $this->oxilab_flip_box_admin_text_align('backend-heading-text-align', $this->style[165], 'Text Align', 'Give your Heading Text Align');
                    echo $this->oxilab_flip_box_admin_number_double('backend-heading-padding-top', $this->style[167], 'backend-heading-padding-bottom', $this->style[169], 'Padding Top Bottom', 'Set Your backend Heading  Padding Top and Bottom');
                    echo $this->oxilab_flip_box_admin_number_double('backend-heading-padding-left', $this->style[171], 'backend-heading-padding-right', $this->style[173], 'Padding Left Right', 'Set Your backend Heading  Padding Left and Right');
                    ?> 
                </div>
            </div>
            <div class="oxi-addons-col-6">
                <div class="oxi-addons-content-div">
                    ...
                    echo $this->oxilab_flip_box_admin_color('backend-info-color', $this->style[25], '', 'Text Color', 'Set your Backend Info Color', 'color', '.oxilab-flip-box-back-' . $this->oxiid . '-data .oxilab-info');
                ...
                <div class="oxi-addons-content-div">
                    ...
                    <?php
                    echo $this->oxilab_flip_box_admin_number('backend-button-size', $this->style[211], '1', 'Font Size', 'Set your Backend Button Font Size');
                    echo $this->oxilab_flip_box_admin_color('backend-button-color', $this->style[31], '', 'Button Color', 'Set your Backend Button Color', 'color', '.oxilab-flip-box-back-' . $this->oxiid . '-data .oxilab-button-data');
                    echo $this->oxilab_flip_box_admin_color('backend-button-background', $this->style[33], 'rgba', 'Buton Background', 'Set your Backend Button Background Color', 'background-color', '.oxilab-flip-box-back-' . $this->oxiid . '-data .oxilab-button-data');
                    echo $this->oxilab_flip_box_admin_color('backend-button-hover-color', $this->style[35], '', 'Button Hover', 'Set your Backend Button Hover Color', 'color', '.oxilab-flip-box-back-' . $this->oxiid . '-data .oxilab-button-data:hover');
                    echo $this->oxilab_flip_box_admin_color('backend-button-hover-background', $this->style[37], 'rgba', 'Button Hover Background', 'Set your Backend Button Hover Background Color', 'background-color', '.oxilab-flip-box-back-' . $this->oxiid . '-data .oxilab-button-data:hover');
                    echo $this->oxilab_flip_box_admin_font_family('backend-button-family', $this->style[213], 'Font Family', 'Give your Prepared Font from our Google Font List');
                    echo $this->oxilab_flip_box_admin_font_style('backend-button-style', $this->style[215], 'Font Style', 'Set your Backend Button Font Style');
                    echo $this->oxilab_flip_box_admin_font_weight('backend-button-weight', $this->style[117], 'Font Weight', 'Give your Backend Button Font Weight');
                    echo $this->oxilab_flip_box_admin_number_double('backend-button-info-padding-top', $this->style[219], 'backend-button-info-padding-left', $this->style[221], 'Padding', 'Set Your Backend Button Padding Top Bottom and left Right');
                    echo $this->oxilab_flip_box_admin_number('backend-button-border-radius', $this->style[223], '1', 'Border Radius', 'Set your Backend Button Border Radius');
                    echo $this->oxilab_flip_box_admin_text_align('backend-button-text-align', $this->style[225], 'Text Align', 'Give your Backend Button Text Align');
                    echo $this->oxilab_flip_box_admin_number_double('backend-info-margin-top', $this->style[227], 'backend-info-margin-bottom', $this->style[229], 'Margin Top Bottom', 'Set Your Backend Info Margin Top and Bottom');
                    echo $this->oxilab_flip_box_admin_number_double('backend-info-margin-left', $this->style[231], 'backend-info-margin-right', $this->style[233], 'Margin Left Right', 'Set Your Backend Info Margin Left and Right');
                    ?> 
                </div> 
            </div>
        </div>    

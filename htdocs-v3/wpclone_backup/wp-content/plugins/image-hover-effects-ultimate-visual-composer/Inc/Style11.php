...
class Style11 extends Admin_Render {
        ...
        <div class="oxi-addons-tabs-content-tabs" id="oxilab-tabs-id-4">
            <div class="oxi-addons-col-6">
                <div class="oxi-addons-content-div">
                    ...
                    <?php
                    echo $this->oxilab_flip_box_admin_color('front-background-color', $this->style[5], 'rgba', 'Background Color', 'Set your Front Background Color', 'background-color', '.oxilab-flip-box-' . $this->oxiid . '');
                ...
                <div class="oxi-addons-content-div">
                    ...
                    <?php
                    echo $this->oxilab_flip_box_admin_number('front-icon-size', $this->style[77], '1', 'Icon Size', 'Set your Icon Font Size');
                    echo $this->oxilab_flip_box_admin_color('front-icon-color', $this->style[7], '', 'Icon Color', 'Set your Icon Color', 'color', '.oxilab-flip-box-' . $this->oxiid . '-data .oxilab-icon-data [class^=\'fa\']');
                    echo $this->oxilab_flip_box_admin_color('front-icon-background-color', $this->style[9], 'rgba', 'Icon Background Color', 'Set your Icon Background Color', 'background-color', '.oxilab-flip-box-' . $this->oxiid . '-data .oxilab-icon-data');
                    echo $this->oxilab_flip_box_admin_number('front-icon-width', $this->style[79], '1', 'Icon width', 'Set your Icon Width and Height Size.');
                    echo $this->oxilab_flip_box_admin_number('front-icon-border-radius', $this->style[81], '1', 'Border Radius', 'Set Your Icon Border Radius');
                    echo $this->oxilab_flip_box_admin_number_double('front-icon-padding-top-bottom', $this->style[133], 'front-icon-padding-left-right', $this->style[135], 'Icon Padding', 'Set your Icon Padding as Top Bottom and Left Right');
                    ?> 
                </div>
            </div>
            <div class="oxi-addons-col-6">
                <div class="oxi-addons-content-div">
                    ...
                    echo $this->oxilab_flip_box_admin_color('front-heading-color', $this->style[11], '', 'Heading Color', 'Set your Front Heading Color', 'color', '.oxilab-flip-box-' . $this->oxiid . '-data .oxilab-heading');
        ...
        <div class="oxi-addons-tabs-content-tabs" id="oxilab-tabs-id-3">
            <div class="oxi-addons-col-6">
                <div class="oxi-addons-content-div">
                    ...
                    <?php
                    echo $this->oxilab_flip_box_admin_color('backend-background-color', $this->style[13], 'rgba', 'Background Color', 'Set your Backend Background Color', 'background-color', '.oxilab-flip-box-back-' . $this->oxiid . '');
                ...
                <div class="oxi-addons-content-div">
                    ...
                    <?php
                    echo $this->oxilab_flip_box_admin_number('backend-icon-size', $this->style[77], '1', 'Icon Size', 'Set your Icon Font Size');
                    echo $this->oxilab_flip_box_admin_color('backend-icon-color', $this->style[17], '', 'Icon Color', 'Set your Icon Color', 'color', '.oxilab-flip-box-back-' . $this->oxiid . '-data .oxilab-icon-data [class^=\'fa\']');
                    echo $this->oxilab_flip_box_admin_number('backend-icon-width', $this->style[79], '1', 'Icon width', 'Set your Icon Width and Height Size.');
                    echo $this->oxilab_flip_box_admin_number('backend-icon-border-bottom', $this->style[105], '1', 'Icon Border Bottom', 'Set your Icon Border Bottom Size.');
                    echo $this->oxilab_flip_box_admin_number_double('backend-icon-padding-top-bottom', $this->style[129], 'backend-icon-padding-left-right', $this->style[131], 'Icon Padding', 'Set your Icon Padding as Top Bottom and Left Right');
                    ?> 
                </div>
                <div class="oxi-addons-content-div">
                    <div class="oxi-head">
                    ...
                    <?php
                    echo $this->oxilab_flip_box_admin_number('backend-heading-size', $this->style[137], '1', 'Font Size', 'Set your backend Heading Font Size');
                    echo $this->oxilab_flip_box_admin_color('backend-title-color', $this->style[15], '', ' Title Color', 'Set your Backend title Color', 'color', '.oxilab-flip-box-back-' . $this->oxiid . '-data .oxilab-heading');
                    echo $this->oxilab_flip_box_admin_font_family('backend-heading-family', $this->style[139], 'Font Family', 'Give your Prepared Font from our Google Font List');
                    echo $this->oxilab_flip_box_admin_font_style('backend-heading-style', $this->style[141], 'Font Style', 'Set your Heading Font Style');
                    echo $this->oxilab_flip_box_admin_font_weight('backend-heading-weight', $this->style[143], 'Font Weight', 'Give your backend Heading Font Weight');
                    echo $this->oxilab_flip_box_admin_text_align('backend-heading-text-align', $this->style[145], 'Text Align', 'Give your Heading Text Align');
                    echo $this->oxilab_flip_box_admin_number_double('backend-heading-padding-top', $this->style[147], 'backend-heading-padding-bottom', $this->style[149], 'Padding Top Bottom', 'Set Your backend Heading  Padding Top and Bottom');
                    echo $this->oxilab_flip_box_admin_number_double('backend-heading-padding-left', $this->style[151], 'backend-heading-padding-right', $this->style[153], 'Padding Left Right', 'Set Your backend Heading  Padding Left and Right');
                    ?> 
                </div>
            </div>
            <div class="oxi-addons-col-6">
                <div class="oxi-addons-content-div">
                    ...
                    echo $this->oxilab_flip_box_admin_color('backend-info-color', $this->style[19], '', 'Text Color', 'Set your Backend Info Color', 'color', '.oxilab-flip-box-back-' . $this->oxiid . '-data .oxilab-info');
                ...
                <div class="oxi-addons-content-div">
                    ...
                    <?php
                    echo $this->oxilab_flip_box_admin_number('backend-button-size', $this->style[155], '1', 'Font Size', 'Set your Backend Button Font Size');
                    echo $this->oxilab_flip_box_admin_color('backend-button-color', $this->style[21], '', 'Button Color', 'Set your Backend Button Color', 'color', '.oxilab-flip-box-back-' . $this->oxiid . '-data .oxilab-button-data');
                    echo $this->oxilab_flip_box_admin_color('backend-button-background', $this->style[23], 'rgba', 'Buton Background', 'Set your Backend Button Background Color', 'background-color', '.oxilab-flip-box-back-' . $this->oxiid . '-data .oxilab-button-data');
                    echo $this->oxilab_flip_box_admin_color('backend-button-hover-color', $this->style[25], '', 'Button Hover', 'Set your Backend Button Hover Color', 'color', '.oxilab-flip-box-back-' . $this->oxiid . '-data .oxilab-button-data:hover');
                    echo $this->oxilab_flip_box_admin_color('backend-button-hover-background', $this->style[27], 'rgba', 'Button Hover Background', 'Set your Backend Button Hover Background Color', 'background-color', '.oxilab-flip-box-back-' . $this->oxiid . '-data .oxilab-button-data:hover');
                    echo $this->oxilab_flip_box_admin_font_family('backend-button-family', $this->style[157], 'Font Family', 'Give your Prepared Font from our Google Font List');
                    echo $this->oxilab_flip_box_admin_font_style('backend-button-style', $this->style[159], 'Font Style', 'Set your Backend Button Font Style');
                    echo $this->oxilab_flip_box_admin_font_weight('backend-button-weight', $this->style[161], 'Font Weight', 'Give your Backend Button Font Weight');
                    echo $this->oxilab_flip_box_admin_number_double('backend-button-info-padding-top', $this->style[163], 'backend-button-info-padding-left', $this->style[165], 'Padding', 'Set Your Backend Button Padding Top Bottom and left Right');
                    echo $this->oxilab_flip_box_admin_number('backend-button-border-radius', $this->style[167], '1', 'Border Radius', 'Set your Backend Button Border Radius');
                    echo $this->oxilab_flip_box_admin_text_align('backend-button-text-align', $this->style[169], 'Text Align', 'Give your Backend Button Text Align');
                    echo $this->oxilab_flip_box_admin_number_double('backend-info-margin-top', $this->style[171], 'backend-info-margin-bottom', $this->style[173], 'Margin Top Bottom', 'Set Your Backend Info Margin Top and Bottom');
                    echo $this->oxilab_flip_box_admin_number_double('backend-info-margin-left', $this->style[175], 'backend-info-margin-right', $this->style[177], 'Margin Left Right', 'Set Your Backend Info Margin Left and Right');
                    ?> 
                </div>  
            </div>
        </div>             
        <div class="oxi-addons-tabs-content-tabs" id="oxilab-tabs-id-2">
            <div class="col-xs-12 p-2">
                <div class="form-group">
                    ...
                    <textarea class="form-control" rows="4" id="custom-css" name="custom-css"><?php echo $this->style[179]; ?></textarea>
    ...
    public function modal_form_data() {
        ...
        <div class="modal-body row">
            ...
            echo $this->oxilab_flip_box_admin_input_icon('flip-box-front-icons', $this->child_editable[3], 'Front Icon', 'Add your front icon, Use Font-Awesome class name. As example fab fa-facebook-f');
        ...
        <div class="modal-body row">
            <?Php
            echo $this->oxilab_flip_box_admin_input_text('flip-box-backend-title', $this->child_editable[7], 'Backend Title', 'Add your flip backend title.');
            echo $this->oxilab_flip_box_admin_input_text_area('flip-box-backend-desc', $this->child_editable[9], 'Backend Info:', 'Add backend Info text unless make it blank.');
            echo $this->oxilab_flip_box_admin_input_icon('flip-box-backend-icons', $this->child_editable[11], 'Backend Icon', 'Add your front icon, Use Font-Awesome class name. As example fab fa-facebook');
            echo $this->oxilab_flip_box_admin_input_text('flip-box-backend-button-text', $this->child_editable[13], 'Backend Button Text', 'Add your backend button text.');
            echo $this->oxilab_flip_box_admin_input_text('flip-box-backend-link', $this->child_editable[15], 'Link', 'Add your desire link or url unless make it blank');
            echo $this->image_upload('flip-box-image-upload-url-02', $this->child_editable[17], 'Backend Background Image', 'Add or Modify Your Backend Background Image. Unless make it blank.');
            ?>                                            
        </div>
        <?php
    }

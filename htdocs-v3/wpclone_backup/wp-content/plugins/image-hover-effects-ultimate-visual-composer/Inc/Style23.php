...
class Style23 extends Admin_Render {
    ...
    public function register_style() {
        $data = 'oxilab-flip-type |' . sanitize_text_field($_POST['oxilab-flip-type']) . '|'
                ...
                . ' backend-margin-top-bottom|' . sanitize_text_field($_POST['backend-margin-top-bottom']) . '|'
                ...
                . ' front-margin-top-bottom|' . sanitize_text_field($_POST['front-margin-top-bottom']) . '|'
        ...
        <div class="oxi-addons-tabs-content-tabs" id="oxilab-tabs-id-4">
            <div class="oxi-addons-col-6">
                <div class="oxi-addons-content-div">
                    ...
                    echo $this->oxilab_flip_box_admin_number('front-margin-top-bottom', $this->style[105], '', 'Margin', 'Set your Front Margin as Top Bottom and Left Right');
                ...
                <div class="oxi-addons-content-div">
                    ...
                    echo $this->oxilab_flip_box_admin_color('front-icon-background-color', $this->style[11], '', 'Icon Background Color', 'Set your Icon Background Color', 'background-color', '.oxilab-flip-box-' . $this->oxiid . '-data .oxilab-icon-data');
            ...
            <div class="oxi-addons-col-6">
                ...
                <div class="oxi-addons-content-div">
                    ...
                    echo $this->oxilab_flip_box_admin_color('front-info-color', $this->style[19], '', 'Text Color', 'Set your Front Heading Color', 'color', '.oxilab-flip-box-' . $this->oxiid . '-data .oxilab-info');
        ...
        <div class="oxi-addons-tabs-content-tabs" id="oxilab-tabs-id-3">
            <div class="oxi-addons-col-6">
                <div class="oxi-addons-content-div">
                    ...
                    echo $this->oxilab_flip_box_admin_number('backend-margin-top-bottom', $this->style[69], '', 'Margin', 'Set your Backend Margin as Top Bottom and Left Right');
            ...
            <div class="oxi-addons-col-6">
                <div class="oxi-addons-content-div">
                    ...
                    <?php
                    echo $this->oxilab_flip_box_admin_number('backend-title-border-width', $this->style[131], '1', 'Border Width', 'Set your Backend Title Bottom Border Width');
                    echo $this->oxilab_flip_box_admin_number('backend-title-border-height', $this->style[133], '1', 'Border Height', 'Set your Backend Title Bottom Border Height');
                    echo $this->oxilab_flip_box_admin_color('backend-title-bottom-border-color', $this->style[25], '', 'Title Bottom Color', 'Set your Backend Title Bottom Border Color', 'background-color', '.oxilab-flip-box-back-' . $this->oxiid . '-data .oxilab-heading .oxilab-span');
                    ?>    
                </div> 
                <div class="oxi-addons-content-div">
                    <div class="oxi-head">
                    ...
                    echo $this->oxilab_flip_box_admin_color('backend-info-color', $this->style[17], '', 'Text Color', 'Set your Backend Info Color', 'color', '.oxilab-flip-box-back-' . $this->oxiid . '-data .oxilab-info');

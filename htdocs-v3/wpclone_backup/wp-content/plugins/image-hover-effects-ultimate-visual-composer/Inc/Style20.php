...
class Style20 extends Admin_Render {
    ...
    public function register_style() {
        $data = 'oxilab-flip-type |' . sanitize_text_field($_POST['oxilab-flip-type']) . '|'
                ...
                . ' front-image-margin-top |' . sanitize_text_field($_POST['front-image-margin-top']) . '|'
                . ' front-image-margin-bottom|' . sanitize_text_field($_POST['front-image-margin-bottom']) . '|'
                . ' front-image-margin-left|' . sanitize_text_field($_POST['front-image-margin-left']) . '|'
                . ' front-image-margin-right|' . sanitize_text_field($_POST['front-image-margin-right']) . '|'
                . ' ||'
                . ' ||'
        ...
        <div class="oxi-addons-tabs-content-tabs" id="oxilab-tabs-id-4">
            <div class="oxi-addons-col-6">
                <div class="oxi-addons-content-div">
                    ...
                    echo $this->oxilab_flip_box_admin_number_double('front-image-margin-top', $this->style[71], 'front-image-margin-bottom', $this->style[73], 'Image Margin Top Bottom', 'Set Your Image Margin Top and Bottom(If Needed)');
                    echo $this->oxilab_flip_box_admin_number_double('front-image-margin-left', $this->style[75], 'front-image-margin-right', $this->style[77], 'Image Margin Left Right', 'Set Your Image Margin Left and Right(If Needed)');
                    ...
                    echo $this->oxilab_flip_box_admin_border('flip-col-border-size', $this->style[163], 'flip-col-border-style', $this->style[165], 'Border Size', 'Set your front border size with different style');
                    ?>    
                </div>                                             
            </div>
            <div class="oxi-addons-col-6">
        ...
        <div class="oxi-addons-tabs-content-tabs" id="oxilab-tabs-id-3">
            <div class="oxi-addons-col-6">
                <div class="oxi-addons-content-div">
                    ...
                    echo $this->oxilab_flip_box_admin_color('backend-border-color', $this->style[9], '', 'Border Color', 'Set your Border Color', 'border-color', '.oxilab-flip-box-back-' . $this->oxiid . '');
                    echo $this->oxilab_flip_box_admin_border('flip-backend-border-size', $this->style[167], 'flip-backend-border-style', $this->style[169], 'Border Size', 'Set your backend border size with different style');
                    ?>    
                </div> 
                <div class="oxi-addons-content-div">
                    <div class="oxi-head">

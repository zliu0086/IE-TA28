...
class Style1 extends Admin_Render {
    ...
    public function register_child() {
        $data = ' flip-box-front-title {#}|{#}' . $this->admin_special_charecter($_POST['flip-box-front-title']) . '{#}|{#}'
                ...
                . ' flip-box-image-upload-url-01 {#}|{#}' . $this->admin_special_charecter($_POST['flip-box-image-upload-url-01']) . '{#}|{#}'
    ...
    public function register_controls() {
        ...
        <?php ?>  
                    <?php
                    echo $this->oxilab_flip_box_admin_color('front-background-color', $this->style[5], 'rgba', 'Background Color', 'Set your Front Background Color', 'background', '.oxilab-flip-box-' . $this->oxiid . '-data');
                    echo $this->oxilab_flip_box_admin_number('front-image-height', $this->style[69], '1', 'Image Height', 'Set your Front Image Height, Based on Percentize with Image Width');
                    ...
                    echo $this->oxilab_flip_box_admin_color('front-border-color', $this->style[7], '', 'Border Color', 'Set your Border Color', 'background-color', '.oxilab-flip-box-' . $this->oxiid . '');
                    echo $this->oxilab_flip_box_admin_number('front-border-size', $this->style[75], '1', 'Border Size', 'Give your Border Size around the Flip');
                    ?>    
                </div> 
                <div class="oxi-addons-content-div">
                    <div class="oxi-head">
        ...
        echo $this->oxilab_flip_box_admin_color('front-icon-color', $this->style[9], '', 'Icon Color', 'Set your Icon Color', 'color', '.oxilab-flip-box-' . $this->oxiid . '-image-icon [class^=\'fa\']');
        echo $this->oxilab_flip_box_admin_color('front-icon-background', $this->style[11], 'rgba', 'Icon Background', 'Set your icon Background Color', 'background', '.oxilab-flip-box-' . $this->oxiid . '-image-icon');
        ...
        echo $this->oxilab_flip_box_admin_color('front-heading-color', $this->style[13], '', 'Title Color', 'Set your Front Title Color', 'color', '.oxilab-flip-box-' . $this->oxiid . '-heading-data');
        ...
        <?php
        echo $this->oxilab_flip_box_admin_color('backend-background-color', $this->style[15], 'rgba', 'Background Color', 'Set your Backend Background Color', 'border-color', '.oxilab-flip-box-back-' . $this->oxiid . '');
        ...
        echo $this->oxilab_flip_box_admin_number('backend-border-size', $this->style[105], '1', 'Border Size', 'Give your Border Size around the Flip');
        echo $this->oxilab_flip_box_admin_color('backend-border-color', $this->style[17], '', 'Border Color', 'Set your Border Color', 'background-color', '.oxilab-flip-box-back-' . $this->oxiid . '');
        ?>    
                </div> 
                <div class="oxi-addons-content-div">
                    <div class="oxi-head">
        ...
        echo $this->oxilab_flip_box_admin_number_double('backend-button-padding-top', $this->style[133], 'backend-button-padding-left', $this->style[135], 'Padding', 'Set Your Backend Button Padding Top Bottom and left Right');
        ...
        <div class="oxi-addons-tabs-content-tabs" id="oxilab-tabs-id-2">
            <div class="col-xs-12 p-2">
                <div class="form-group">
                    ...
                    <textarea class="form-control" rows="4" id="custom-css" name="custom-css"><?php echo $this->style[149]; ?></textarea>

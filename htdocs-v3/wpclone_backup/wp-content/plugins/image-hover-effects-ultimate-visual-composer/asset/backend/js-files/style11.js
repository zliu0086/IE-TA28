...
jQuery("#backend-icon-border-bottom").on("change", function () {
    jQuery("<style type='text/css'> .oxilab-flip-box-back-" + styleid + "-data .oxilab-icon-data{border-bottom: " + jQuery(this).val() + "px solid; } </style>").appendTo("#oxi-addons-preview-data");
});
...
jQuery("#backend-icon-color").on("change", function () {
    jQuery("<style type='text/css'> .oxilab-flip-box-back-" + styleid + "-data .oxilab-icon-data{Border-bottom-color: " + jQuery(this).val() + ";} </style>").appendTo("#oxi-addons-preview-data");
});
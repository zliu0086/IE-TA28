...
jQuery("#front-padding-top").on("change", function () {
    jQuery("<style type='text/css'> .oxilab-flip-box-" + styleid + "{top: " + jQuery(this).val() + "px;} </style>").appendTo("#oxi-addons-preview-data");
    jQuery("<style type='text/css'> .oxilab-flip-box-" + styleid + "{bottom: " + jQuery(this).val() + "px;} </style>").appendTo("#oxi-addons-preview-data");
});
jQuery("#front-padding-left").on("change", function () {
    jQuery("<style type='text/css'> .oxilab-flip-box-" + styleid + "{left: " + jQuery(this).val() + "px;} </style>").appendTo("#oxi-addons-preview-data");
    jQuery("<style type='text/css'> .oxilab-flip-box-" + styleid + "{right: " + jQuery(this).val() + "px;} </style>").appendTo("#oxi-addons-preview-data");
});
jQuery("#front-inner-padding-top").on("change", function () {
    jQuery("<style type='text/css'> .oxilab-flip-box-" + styleid + "-data{padding: " + jQuery(this).val() + "px " + jQuery("#front-inner-padding-left").val() + "px;} </style>").appendTo("#oxi-addons-preview-data");
});
jQuery("#front-inner-padding-left").on("change", function () {
    jQuery("<style type='text/css'> .oxilab-flip-box-" + styleid + "-data{padding: " + jQuery("#front-inner-padding-top").val() + "px " + jQuery(this).val() + "px;} </style>").appendTo("#oxi-addons-preview-data");
});
jQuery("#flip-col-border-size").on("change", function () {
    jQuery("<style type='text/css'> .oxilab-flip-box-body-" + styleid + " .oxilab-flip-box-front{border-width: " + jQuery(this).val() + "px; } </style>").appendTo("#oxi-addons-preview-data");
});
jQuery("#flip-col-border-style").on("change", function () {
    jQuery("<style type='text/css'> .oxilab-flip-box-body-" + styleid + " .oxilab-flip-box-front{border-style: " + jQuery(this).val() + "; } </style>").appendTo("#oxi-addons-preview-data");
});
jQuery("#flip-col-inner-border-size").on("change", function () {
...
jQuery("#flip-col-inner-border-style").on("change", function () {
    jQuery("<style type='text/css'> .oxilab-flip-box-" + styleid + "{border-style: " + jQuery(this).val() + "; } </style>").appendTo("#oxi-addons-preview-data");
});
jQuery("#flip-inner-border-radius").on("change", function () {
    jQuery("<style type='text/css'> .oxilab-flip-box-" + styleid + "{border-radius: " + jQuery(this).val() + "px; } </style>").appendTo("#oxi-addons-preview-data");
});
jQuery("#front-icon-size").on("change", function () {
    jQuery("<style type='text/css'> .oxilab-flip-box-" + styleid + "-data2 .oxilab-icon-data .oxilab-span{font-size: " + jQuery(this).val() + "px; } </style>").appendTo("#oxi-addons-preview-data");
});
jQuery("#front-icon-width").on("change", function () {
    jQuery("<style type='text/css'> .oxilab-flip-box-" + styleid + "-data2{width: " + jQuery(this).val() + "px; } </style>").appendTo("#oxi-addons-preview-data");
    jQuery("<style type='text/css'> .oxilab-flip-box-" + styleid + "-data2 .oxilab-icon-data{width: " + jQuery(this).val() + "px; } </style>").appendTo("#oxi-addons-preview-data");
    jQuery("<style type='text/css'> .oxilab-flip-box-" + styleid + "-data2 .oxilab-icon-data{height: " + jQuery(this).val() + "px; } </style>").appendTo("#oxi-addons-preview-data");
    jQuery("<style type='text/css'> .oxilab-flip-box-" + styleid + "-data2 .oxilab-icon-data .oxilab-span{line-height: " + jQuery(this).val() + "px; } </style>").appendTo("#oxi-addons-preview-data");
});
jQuery("#front-icon-height").on("change", function () {
    jQuery("<style type='text/css'> .oxilab-flip-box-" + styleid + "-data{top: " + jQuery(this).val() + "px; } </style>").appendTo("#oxi-addons-preview-data");
    jQuery("<style type='text/css'> .oxilab-flip-box-" + styleid + "-data2{height: " + jQuery(this).val() + "px; } </style>").appendTo("#oxi-addons-preview-data");
});
jQuery("#front-icon-border-radius").on("change", function () {
    jQuery("<style type='text/css'> .oxilab-flip-box-" + styleid + "-data2{border-radius: 0 0 " + jQuery(this).val() + "px " + jQuery(this).val() + "px; } </style>").appendTo("#oxi-addons-preview-data");
    jQuery("<style type='text/css'> .oxilab-flip-box-" + styleid + "-data2 .oxilab-icon-data{border-radius: 0 0  " + jQuery(this).val() + "px " + jQuery(this).val() + "px; } </style>").appendTo("#oxi-addons-preview-data");
});
...
jQuery("#front-info-size").on("change", function () {
    jQuery("<style type='text/css'> .oxilab-flip-box-" + styleid + "-data .oxilab-info{font-size: " + jQuery(this).val() + "px; } </style>").appendTo("#oxi-addons-preview-data");
});
jQuery('#front-info-family').change(function () {
    var font = jQuery(this).val().replace(/\+/g, ' ');
    font = font.split(':');
    jQuery("<style type='text/css'> .oxilab-flip-box-" + styleid + "-data .oxilab-info{ font-family:" + font[0] + ";} </style>").appendTo("#oxi-addons-preview-data");
});
jQuery("#front-info-style").on("change", function () {
    jQuery("<style type='text/css'> .oxilab-flip-box-" + styleid + "-data .oxilab-info{font-style: " + jQuery(this).val() + "; } </style>").appendTo("#oxi-addons-preview-data");
});
jQuery("#front-info-weight").on("change", function () {
    jQuery("<style type='text/css'> .oxilab-flip-box-" + styleid + "-data .oxilab-info{font-weight: " + jQuery(this).val() + "; } </style>").appendTo("#oxi-addons-preview-data");
});
jQuery("#front-info-text-align").on("change", function () {
    jQuery("<style type='text/css'> .oxilab-flip-box-" + styleid + "-data .oxilab-info{text-align: " + jQuery(this).val() + "; } </style>").appendTo("#oxi-addons-preview-data");
});
jQuery("#front-info-padding-top").on("change", function () {
    jQuery("<style type='text/css'> .oxilab-flip-box-" + styleid + "-data .oxilab-info{padding: " + jQuery(this).val() + "px " + jQuery("#front-info-padding-right").val() + "px " + jQuery("#front-info-padding-bottom").val() + "px " + jQuery("#front-info-padding-left").val() + "px;} </style>").appendTo("#oxi-addons-preview-data");
});
jQuery("#front-info-padding-bottom").on("change", function () {
    jQuery("<style type='text/css'> .oxilab-flip-box-" + styleid + "-data .oxilab-info{padding: " + jQuery("#front-info-padding-top").val() + "px " + jQuery("#front-info-padding-right").val() + "px " + jQuery(this).val() + "px " + jQuery("#front-info-padding-left").val() + "px;} </style>").appendTo("#oxi-addons-preview-data");
});
jQuery("#front-info-padding-right").on("change", function () {
    jQuery("<style type='text/css'> .oxilab-flip-box-" + styleid + "-data .oxilab-info{padding: " + jQuery("#front-info-padding-top").val() + "px " + jQuery(this).val() + "px " + jQuery("#front-info-padding-bottom").val() + "px " + jQuery("#front-info-padding-left").val() + "px;} </style>").appendTo("#oxi-addons-preview-data");
});
jQuery("#front-info-padding-left").on("change", function () {
    jQuery("<style type='text/css'> .oxilab-flip-box-" + styleid + "-data .oxilab-info{padding: " + jQuery("#front-info-padding-top").val() + "px " + jQuery("#front-info-padding-right").val() + "px " + jQuery("#front-info-padding-bottom").val() + "px " + jQuery(this).val() + "px;} </style>").appendTo("#oxi-addons-preview-data");
});
jQuery("#backend-padding-top").on("change", function () {
    jQuery("<style type='text/css'> .oxilab-flip-box-back-" + styleid + "{top: " + jQuery(this).val() + "px;} </style>").appendTo("#oxi-addons-preview-data");
    jQuery("<style type='text/css'> .oxilab-flip-box-back-" + styleid + "{bottom: " + jQuery(this).val() + "px;} </style>").appendTo("#oxi-addons-preview-data");
});
jQuery("#backend-padding-left").on("change", function () {
    jQuery("<style type='text/css'> .oxilab-flip-box-back-" + styleid + "{left: " + jQuery(this).val() + "px;} </style>").appendTo("#oxi-addons-preview-data");
    jQuery("<style type='text/css'> .oxilab-flip-box-back-" + styleid + "{right: " + jQuery(this).val() + "px;} </style>").appendTo("#oxi-addons-preview-data");
});
jQuery("#front-backend-inner-padding-top").on("change", function () {
    jQuery("<style type='text/css'> .oxilab-flip-box-back-" + styleid + "-data{padding: " + jQuery(this).val() + "px " + jQuery("#front-backend-inner-padding-left").val() + "px;} </style>").appendTo("#oxi-addons-preview-data");
});
jQuery("#front-backend-inner-padding-left").on("change", function () {
    jQuery("<style type='text/css'> .oxilab-flip-box-back-" + styleid + "-data{padding: " + jQuery("#front-backend-inner-padding-top").val() + "px " + jQuery(this).val() + "px;} </style>").appendTo("#oxi-addons-preview-data");
});
jQuery("#flip-backend-border-size").on("change", function () {
    jQuery("<style type='text/css'> .oxilab-flip-box-body-" + styleid + " .oxilab-flip-box-back{border-width: " + jQuery(this).val() + "px; } </style>").appendTo("#oxi-addons-preview-data");
});
jQuery("#flip-backend-border-style").on("change", function () {
    jQuery("<style type='text/css'> .oxilab-flip-box-body-" + styleid + " .oxilab-flip-box-back{border-style: " + jQuery(this).val() + "; } </style>").appendTo("#oxi-addons-preview-data");
});
jQuery("#flip-backend-inner-border-size").on("change", function () {
...
jQuery("#flip-backend-inner-border-style").on("change", function () {
...
jQuery("#flip-backend-inner-border-radius").on("change", function () {
    jQuery("<style type='text/css'> .oxilab-flip-box-back-" + styleid + "{border-radius: " + jQuery(this).val() + "px; } </style>").appendTo("#oxi-addons-preview-data");
});
jQuery("#backend-icon-size").on("change", function () {
    jQuery("<style type='text/css'> .oxilab-flip-box-back-" + styleid + "-data2 .oxilab-icon-data .oxi-icons{font-size: " + jQuery(this).val() + "px; } </style>").appendTo("#oxi-addons-preview-data");
});
jQuery("#backend-icon-width").on("change", function () {
    jQuery("<style type='text/css'> .oxilab-flip-box-back-" + styleid + "-data2{width: " + jQuery(this).val() + "px; } </style>").appendTo("#oxi-addons-preview-data");
    jQuery("<style type='text/css'> .oxilab-flip-box-back-" + styleid + "-data2 .oxilab-icon-data{width: " + jQuery(this).val() + "px; } </style>").appendTo("#oxi-addons-preview-data");
    jQuery("<style type='text/css'> .oxilab-flip-box-back-" + styleid + "-data2 .oxilab-icon-data{height: " + jQuery(this).val() + "px; } </style>").appendTo("#oxi-addons-preview-data");
    jQuery("<style type='text/css'> .oxilab-flip-box-back-" + styleid + "-data2 .oxilab-icon-data .oxi-icons{line-height: " + jQuery(this).val() + "px; } </style>").appendTo("#oxi-addons-preview-data");
});
jQuery("#backend-icon-height").on("change", function () {
    jQuery("<style type='text/css'> .oxilab-flip-box-back-" + styleid + "-data{top: " + jQuery(this).val() + "px; } </style>").appendTo("#oxi-addons-preview-data");
    jQuery("<style type='text/css'> .oxilab-flip-box-back-" + styleid + "-data2{height: " + jQuery(this).val() + "px; } </style>").appendTo("#oxi-addons-preview-data");
});
jQuery("#backend-icon-border-radius").on("change", function () {
    jQuery("<style type='text/css'> .oxilab-flip-box-back-" + styleid + "-data2{border-radius: 0 0 " + jQuery(this).val() + "px " + jQuery(this).val() + "px; } </style>").appendTo("#oxi-addons-preview-data");
});

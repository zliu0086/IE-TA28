...
jQuery("#front-title-border-width").on("change", function () {
    jQuery("<style type='text/css'> .oxilab-flip-box-" + styleid + "-data .oxilab-heading .oxilab-span{width: " + jQuery(this).val() + "px; } </style>").appendTo("#oxi-addons-preview-data");
});
jQuery("#front-title-border-height").on("change", function () {
    jQuery("<style type='text/css'> .oxilab-flip-box-" + styleid + "-data .oxilab-heading .oxilab-span{height: " + jQuery(this).val() + "px; } </style>").appendTo("#oxi-addons-preview-data");
});
...
jQuery("#backend-icon-size").on("change", function () {
    jQuery("<style type='text/css'> .oxilab-flip-box-back-" + styleid + "-data .oxilab-icon-data .oxi-icons{font-size: " + jQuery(this).val() + "px; } </style>").appendTo("#oxi-addons-preview-data");
});
jQuery("#backend-icon-width").on("change", function () {
    jQuery("<style type='text/css'> .oxilab-flip-box-back-" + styleid + "-data .oxilab-icon-data{width: " + jQuery(this).val() + "px; } </style>").appendTo("#oxi-addons-preview-data");
    jQuery("<style type='text/css'> .oxilab-flip-box-back-" + styleid + "-data .oxilab-icon-data{height: " + jQuery(this).val() + "px; } </style>").appendTo("#oxi-addons-preview-data");
    jQuery("<style type='text/css'> .oxilab-flip-box-back-" + styleid + "-data .oxilab-icon-data .oxi-icons{line-height: " + jQuery(this).val() + "px; } </style>").appendTo("#oxi-addons-preview-data");
});
jQuery("#backend-icon-padding-top-bottom").on("change", function () {
    jQuery("<style type='text/css'> .oxilab-flip-box-back-" + styleid + "-data .oxilab-icon{padding: " + jQuery(this).val() + "px " + jQuery("#backend-icon-padding-left-right").val() + "px; } </style>").appendTo("#oxi-addons-preview-data");
});
jQuery("#backend-icon-padding-left-right").on("change", function () {
    jQuery("<style type='text/css'> .oxilab-flip-box-back-" + styleid + "-data .oxilab-icon{padding: " + jQuery("#backend-icon-padding-top-bottom").val() + "px " + jQuery(this).val() + "px; } </style>").appendTo("#oxi-addons-preview-data");
});

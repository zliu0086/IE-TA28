...
jQuery("#front-image-height").on("change", function () {
    jQuery("<style type='text/css'> .oxilab-flip-box-" + styleid + "-data .oxilab-image:after{padding-bottom: " + jQuery(this).val() + "%;} </style>").appendTo("#oxi-addons-preview-data");
});
jQuery("#front-image-margin-top").on("change", function () {
    jQuery("<style type='text/css'> .oxilab-flip-box-" + styleid + "-data .oxilab-image{margin: " + jQuery(this).val() + "px " + jQuery("#front-image-margin-right").val() + "px " + jQuery("#front-image-margin-bottom").val() + "px " + jQuery("#front-image-margin-left").val() + "px; } </style>").appendTo("#oxi-addons-preview-data");
});
jQuery("#front-image-margin-right").on("change", function () {
    jQuery("<style type='text/css'> .oxilab-flip-box-" + styleid + "-data .oxilab-image{margin: " + jQuery("#front-image-margin-top").val() + "px " + jQuery(this).val() + "px " + jQuery("#front-image-margin-bottom").val() + "px " + jQuery("#front-image-margin-left").val() + "px; } </style>").appendTo("#oxi-addons-preview-data");
});
jQuery("#front-image-margin-bottom").on("change", function () {
    jQuery("<style type='text/css'> .oxilab-flip-box-" + styleid + "-data .oxilab-image{margin: " + jQuery("#front-image-margin-top").val() + "px " + jQuery("#front-image-margin-right").val() + "px " + jQuery(this).val() + "px " + jQuery("#front-image-margin-left").val() + "px; } </style>").appendTo("#oxi-addons-preview-data");
});
jQuery("#front-image-margin-left").on("change", function () {
    jQuery("<style type='text/css'> .oxilab-flip-box-" + styleid + "-data .oxilab-image{margin: " + jQuery("#front-image-margin-top").val() + "px " + jQuery("#front-image-margin-right").val() + "px " + jQuery("#front-image-margin-bottom").val() + "px " + jQuery(this).val() + "px; } </style>").appendTo("#oxi-addons-preview-data");
});

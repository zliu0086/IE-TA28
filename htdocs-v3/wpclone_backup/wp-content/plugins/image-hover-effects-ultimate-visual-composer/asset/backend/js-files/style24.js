...
jQuery("#front-icon-border-radius").on("change", function () {
    jQuery("<style type='text/css'> .oxilab-flip-box-" + styleid + "-data .oxilab-icon-data{border-radius: " + jQuery(this).val() + "px; } </style>").appendTo("#oxi-addons-preview-data");
});
...
jQuery("#backend-icon-border-radius").on("change", function () {
    jQuery("<style type='text/css'> .oxilab-flip-box-back-" + styleid + "-data .oxilab-icon-data{border-radius: " + jQuery(this).val() + "px; } </style>").appendTo("#oxi-addons-preview-data");
});
jQuery("#backend-icon-padding-top-bottom").on("change", function () {
    jQuery("<style type='text/css'> .oxilab-flip-box-back-" + styleid + "-data .oxilab-icon-data{padding: " + jQuery(this).val() + "px " + jQuery("#backend-icon-padding-left-right").val() + "px; } </style>").appendTo("#oxi-addons-preview-data");
});
jQuery("#backend-icon-padding-left-right").on("change", function () {
    jQuery("<style type='text/css'> .oxilab-flip-box-back-" + styleid + "-data .oxilab-icon-data{padding: " + jQuery("#backend-icon-padding-top-bottom").val() + "px " + jQuery(this).val() + "px; } </style>").appendTo("#oxi-addons-preview-data");
});

...
jQuery("#front-icon-size").on("change", function () {
    jQuery("<style type='text/css'> .oxilab-flip-box-" + styleid + "-data2 .oxilab-icon-data .oxi-icons{font-size: " + jQuery(this).val() + "px; } </style>").appendTo("#oxi-addons-preview-data");
});
jQuery("#front-icon-width").on("change", function () {
    ...
    jQuery("<style type='text/css'> .oxilab-flip-box-" + styleid + "-data2 .oxilab-icon-data .oxi-icons{line-height: " + jQuery(this).val() + "px; } </style>").appendTo("#oxi-addons-preview-data");
});

        ...
        <form class="ays-quiz-category-form" id="ays-quiz-category-form" method="post">
                ...
                <div class="form-group row" style="margin:0px;">
                    <div class="col-sm-12 only_pro" style="padding:10px 0 0 10px;">
                        ...
                        <div class="form-group row ays_toggle_parent">
                            ...
                            <div class="col-sm-1">
                                <input type="checkbox" id="ays_add_post_for_quiz" value="on" class="ays_toggle_checkbox" checked/>
                            </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">                        
                                        <div class="input-group">
                                            <select id="ays_add_postcat_for_quiz" class="ays_postcat_for_quiz" multiple>
                                                <option value="1" selected><?php echo __("Uncategorized", $this->plugin_name); ?></option>
                                            </select>
                                        </div>
                                    </div>
                                </div>                   
            ...
            <div id="tab3" class="ays-quiz-tab-content <?php echo ($ays_quiz_tab == 'tab3') ? 'ays-quiz-tab-content-active' : ''; ?>">
                ...
                <div class="form-group row ays_toggle_parent">
                    <div class="col-sm-4" style="padding-right: 0px;">
                        <label for="ays_enable_correction">
                            ...
                            <a class="ays_help" data-toggle="tooltip" title="<?php echo __('Show if the selected answer is right or wrong with green and red marks. To decide when the right/wrong answers will be shown go to “Text for right/wrong answers show option”.',$this->plugin_name)?>">
                                <i class="ays_fa ays_fa_info_circle"></i>
                            </a>
                        </label>
                    </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-4">
                                <label class="form-check-label" for="ays_finish_after_wrong_answer">
                                    <?php echo __('Finish the quiz after making one wrong answer', $this->plugin_name); ?>
                                    <a class="ays_help" data-toggle="tooltip"
                                    title="<?php echo __('Finish the quiz after making one wrong answer.', $this->plugin_name) ?>">
                                        <i class="ays_fa ays_fa_info_circle"></i>
                                    </a>
                                </label>
                            </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-4">
                                        <label class="form-check-label" for="ays_show_only_wrong_answer">
                                            <?php echo __('Show only wrong answer', $this->plugin_name); ?>
                                            <a class="ays_help" data-toggle="tooltip"
                ...
                <div class="form-group row">
                    <div class="col-sm-4">
                        <label>
                            <?php echo __('Show questions explanation',$this->plugin_name)?>
                ...
                <div class="form-group row ays_toggle_parent">
                    <div class="col-sm-4">
                        <label>
                            <?php echo __('Text instead of question hint icon',$this->plugin_name)?>
                    ...
                    <div class="col-sm-3">
                        ...
                        <label class="ays_quiz_loader">
                            ...
                            <span><?php echo __( "Text", $this->plugin_name ); ?></span>
                        </label>
                    </div>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-3">
                                    <label for="timer_text">
                                        <?php echo __("Text before starting the quiz", $this->plugin_name); ?>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-3">
                                    <label for="after_timer_text">
                                        <?php echo __("Text after timer ends", $this->plugin_name); ?>
                                ...
                                <div class="col-sm-9">
                                    <?php
                                        ...
                                        $settings = array('editor_height' => '4', 'textarea_name' => 'ays_after_timer_text', 'editor_class' => 'ays-textarea', 'media_elements' => false);
                                        wp_editor($content, $editor_id, $settings);
                                    ?>
                                </div>
                            </div>
                ...
                <div class="form-group row">
                    <div class="col-sm-4">
                        <label class="form-check-label" for="ays-pass-score">
                            ...
                            <a class="ays_help" data-toggle="tooltip" title="<?php echo __('The minimum score to pass the quiz (by percentage).',$this->plugin_name)?>">
                                <i class="ays_fa ays_fa_info_circle"></i>
                            </a>
                        </label>
                    </div>
                ...
                <div class="form-group row" style="position:relative;">
                    <div class="col-sm-12" style="padding:15px;">
                        ...
                        <div class="form-group row ays_toggle_parent">
                            ...
                            <div class="col-sm-1">
                                <input type="checkbox" class="ays-enable-timer1 ays_toggle_checkbox" id="ays_enable_restriction_pass_users" value="on" checked />
                            </div>
                ...
                <div class="form-group row" style="position:relative;">
                    <div class="col-sm-12" style="padding:15px;">
                        ...
                        <div class="form-group row ays_toggle_parent">
                            ...
                            <div class="col-sm-1">
                                <input type="checkbox" class="ays-enable-timer1 ays_toggle_checkbox" id="ays_enable_password" value="on" checked />
                            </div>
                            <div class="col-sm-8 ays_toggle_target ays_divider_left">
                                <div class="form-group row">
                                    <div class="col-sm-2">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="ays-enable-timer ays-text-input">
                                    </div>
                                </div>
                            </div>

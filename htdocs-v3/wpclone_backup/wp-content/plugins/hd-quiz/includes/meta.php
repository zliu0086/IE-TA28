...
function hdq_get_quiz_meta()
{
    ...
    $default = '{"results":[{"type":"integer","name":"quiz_pass_percentage","label":"Quiz Pass Percentage","placeholder":"50","suffix":"%","tooltip":"The percentage of the questions does a user need to get correct in order to pass the quiz.","default":70,"required":true,"options":[{"name":"step","value":1},{"name":"min","value":0},{"name":"max","value":100}]},{"type":"col-1-1","children":[{"type":"editor","name":"quiz_pass_text","label":"Quiz Pass text","tooltip":"This content will appear if the user passes the quiz. Feel free to add images,video,links etc.","value":""},{"type":"editor","name":"quiz_fail_text","label":"Quiz Fail text","tooltip":"This content will appear if the user passes the quiz. Feel free to add images,video,links etc.","value":""}]}],"marking":[{"type":"col-1-1","children":[{"type":"checkbox","name":"show_results","label":"Highlight correct / incorrect selected answers on completion","content":"<p>This will show the user which questions they got right,and which they got wrong.</p>","value":"","options":[{"label":"","value":"yes","default":"true"}]},{"type":"checkbox","name":"show_results_correct","label":"Show the correct answers on completion","content":"<p>This feature goes the extra step and shows what the correct answer was in the case that the user selected the wrong one.</p>","value":"","options":[{"label":"","value":"yes"}]},{"type":"checkbox","name":"show_results_now","label":"Immediately mark answer as correct or incorrect","content":"<p>Enabling this will show if the answer was right or wrong as soon as an answer has been selected.</p>","value":"","options":[{"label":"","value":"yes"}]},{"type":"checkbox","name":"stop_answer_reselect","label":"Stop users from changing their answers","content":"<p>Enabling this will stop users from being able to change their answer once one has been selected.</p>","value":"","options":[{"label":"","value":"yes"}]}]},{"type":"checkbox","name":"show_extra_text","label":"Always Show Incorrect Answer Text","content":"<p>Each individual question can have accompanying text that will show if the user selects the wrong answer. Enabling this feature will force this text to show even if the selected answer was correct.</p>","value":"","options":[{"label":"","value":"yes"}]}],"timer":[{"type":"content","name":"timer_content_descriptor","value":"<p>If the timer is enabled,the quiz will be hidden behind a \"START QUIZ\" button. You can rename this button from the HD Quiz -> About / Options page</p>"},{"type":"col-1-1","children":[{"type":"integer","name":"quiz_timer","label":"Timer / Countdown","placeholder":"60","suffix":"seconds","content":"<p>Enter how many seconds total. So 3 minutes would be 180. Please note that the timer will NOT work if the WP Pagination feature is being used.</p>","options":[{"name":"step","value":1},{"name":"min","value":0},{"name":"max","value":9999999}]},{"type":"checkbox","name":"quiz_timer_question","label":"Per question","placeholder":"0","content":"<p>Enable this if you want the timer to be per question instead of for the entire quiz.</p>","options":[{"label":"","value":"yes"}]}]}],"advanced":[{"type":"col-1-1","children":[{"type":"checkbox","name":"share_results","label":"Share Quiz Results","tooltip":"This option shows or hides the Facebook and Twitter share buttons that appears when a user completes the quiz.","value":"","options":[{"label":"","value":"yes","default":"true"}]},{"type":"radio","name":"results_position","label":"Show Results Above or Below Quiz","tooltip":"The site will automatically scroll to the position of the results.","value":"","options":[{"label":"Above quiz","value":"above","default":"true"},{"label":"Below quiz","value":"below"}]}]},{"type":"col-1-1","children":[{"type":"checkbox","name":"randomize_questions","label":"Randomize <u>Question</u> Order","content":"<p>Please note that randomizing the questions is NOT possible if the below WP Pagination feature is being used.</p><p><small>and also not a good idea to use this if you are using the \"questions as title\" option for any questions attached to this quiz</small></p>","value":"","options":[{"label":"","value":"yes"}]},{"type":"checkbox","name":"randomize_answers","label":"Randomize <u>Answer</u> Order","content":"<p>This feature will randomize the order that each answer is displayed and <em>is</em> compatible with WP Pagination.</p>","value":"","options":[{"label":"","value":"yes"}]},{"type":"integer","name":"pool_of_questions","label":"Use Pool of Questions","placeholder":"leave blank to disable","suffix":"questions","tooltip":"Set to 0 or leave blank to disable","content":"<p>If you want each quiz to randomly grab a number of questions from the quiz,then enter that amount here. So,for example,you might have 100 questions attached to this quiz,but entering 20 here will make the quiz randomly grab 20 of the questions on each load.</p>","default":"","options":[{"name":"step","value":1},{"name":"min","value":0},{"name":"max","value":9999999}]},{"type":"integer","name":"wp_paginate","label":"WP Pagination","placeholder":"leave blank to disable","suffix":"per page","tooltip":"WARNING:It is generally not recommended using this feature unless you have a specific use case for it.","content":"<p>WP Paginate will force this number of questions per page,and force new page loads for each new question group. The only benefit of this is for additional ad views. The downside is reduced compatibility of features. It is recommended to use the \"paginate\" option on each question instead.</p>","default":"","options":[{"name":"step","value":1},{"name":"min","value":0},{"name":"max","value":9999999}]}]}]}';
...
{
    $default = '{"main":[{"type":"select","name":"question_type","label":"Question Type","required":true,"options":[{"label":"Multiple Choice:Text","value":"multiple_choice_text","default":"true"},{"label":"Multiple Choice:Image","value":"multiple_choice_image"},{"label":"Text Based Answers","value":"text_based"},{"label":"Use Question as Title","value":"title"}]},{"type":"content","value":"","name":"question_type_tip"},{"type":"action","function":"hdq_print_answers_admin","name":"answers"}],"extra":[{"type":"col-1-1","children":[{"type":"checkbox","name":"paginate","label":"Paginate","content":"<p>Start a new page with this question <br/> <small>user will need to select \"next\" to see this question or ones below it</small></p>","options":[{"label":"","value":"yes"}]},{"type":"text","name":"tooltip","label":"Tooltip Text","tooltip":"This popup is an example of what a tooltip is."}]},{"type":"image","name":"featured_image","label":"Question Featured Image","options":{"title":"Set Question Featured Image","button":"SET FEATURED IMAGE","multiple":false}},{"type":"editor","name":"extra_text","label":"Text that appears if the user got the question wrong","tooltip":"You can make it so this text always appears by editing the quiz settings"}],"quizzes":[{"type":"action","function":"hdq_print_quizzes_admin","name":"quizzes"}]}';
    $default = json_decode($default, true);
            ...
            <div class="hdq_category">
                <label class="hdq_full_label" for="cat_<?php echo $terms[$i]->term_id; ?>">
                    <div class="hdq_checkbox">
                        ...
                        <label for="cat_<?php echo $terms[$i]->term_id; ?>"></label>
                    </div>

    ...
    <form method="post" id="lockout-notfound-frm" class="ip-frm" @submit.prevent="updateSettings">
      ...
      <div class="sui-box-body">
        ...
        <div class="sui-box-settings-row">
          ...
          <div class="sui-box-settings-col-2">
            <sidetab :active="model.detect_404_lockout_ban"
                     @selected="model.detect_404_lockout_ban = $event"
                     slug="detect_404_lockout_ban" :labels="[
                         {
                           text:__('Timeframe'),
                           mute:false,
                           value:false
            ...
            >
              <template v-slot:false>
                <div class="sui-row">
                  <div class="sui-col-md-3">
                    <label for="detect_404_lockout_duration" id="label_detect_404_lockout_duration"
                           class="sui-label">{{ __("Duration") }}</label>
                  ...
                  <div class="sui-col-md-4">
                    <label for="detect_404_lockout_duration_unit" id="label_detect_404_lockout_duration_unit"

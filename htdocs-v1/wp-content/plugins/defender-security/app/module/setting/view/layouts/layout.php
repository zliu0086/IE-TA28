                ...
                <div class="sui-box" role="document">
                    ...
                    <div class="sui-box-header">
                        <h3 class="sui-box-title"
                            id="dialogTitle"><?php _e( "Reset Settings", "defender-security" ) ?></h3>
                        <div class="sui-actions-right">
                    ...
                    <div class="sui-box-body">
                        <p id="dialogDescription">
							<?php _e( "Are you sure you want to reset Defender’s settings back to the factory defaults?", "defender-security" ) ?>
                        </p>

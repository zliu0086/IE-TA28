...
var $ = jQuery;
var inlineGoodPracticeCSS = "#qwizard_wrapper .qwiz-mce-bubbleBar{position:absolute !important;z-index:9999;border-radius:5px;box-shadow:0 2px 8px rgba(0,0,0,.75);opacity:1!important;visibility:hidden}.qwiz-mce-bubbleBar.mce-tbActiveBar{position:absolute !important;z-index:9;opacity:.95!important;visibility:visible!important;animation:tinyBubble-pop-upwards 180ms forwards linear}.qwiz-mce-bubbleBar.qwiz-mce-bubbleBarSticky{visibility:visible!important;opacity:1!important;}@keyframes tinyBubble-pop-upwards{0%{opacity:0;transform:matrix(.97,0,0,1,0,12)}20%{opacity:.7;transform:matrix(.99,0,0,1,0,2)}40%{opacity:1;transform:matrix(1,0,0,1,0,-1)}100%{transform:matrix(1,0,0,1,0,0)}}";
//var inlineGoodPracticeCSS = ".qwiz-mce-bubbleBar{position:absolute !important;z-index:9999;border-radius:5px;box-shadow:0 2px 8px rgba(0,0,0,.75);}.qwiz-mce-bubbleBar.mce-tbActiveBar{position:absolute !important;z-index:9;opacity:.95!important;visibility:visible!important;animation:tinyBubble-pop-upwards 180ms forwards linear}.qwiz-mce-bubbleBar.qwiz-mce-bubbleBarSticky{visibility:visible!important;opacity:1!important;}@keyframes tinyBubble-pop-upwards{0%{opacity:0;transform:matrix(.97,0,0,1,0,12)}20%{opacity:.7;transform:matrix(.99,0,0,1,0,2)}40%{opacity:1;transform:matrix(1,0,0,1,0,-1)}100%{transform:matrix(1,0,0,1,0,0)}}";
...
function bubbleUp(editor, addClass) {
  if (addClass == 'addClass') {
    ...
    thisEd.addClass("qwiz-mce-bubbleBar")
  }
  if (addClass == 'addClassSticky') {
    ...
    if (thisEd.hasClass("qwiz-mce-bubbleBarSticky")){
      thisEd.removeClass("qwiz-mce-bubbleBarSticky")
    }
    else{
      thisEd.addClass("qwiz-mce-bubbleBarSticky")
    }
  }
  setTimeout(function() {
    ...
    if (rangey.trim() !== '') {
      ...
      //console.log ('[tinymceBubbleBar > bubbleUp] document_qwiz_bubblebar_enabled_b:', document_qwiz_bubblebar_enabled_b);
      if (document_qwiz_bubblebar_enabled_b) {
        fineTuneBarPosition(editor, range, bar);
      }
    } else {
      $('.qwiz-mce-bubbleBar').removeClass('mce-tbActiveBar')
    }
  }, 100)
}
